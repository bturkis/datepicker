...
<div class="demo-block">
  ...
  <BtDatePicker v-model="singleDate" placeholder="Wybierz date" lang="pl" />
</div>
...
<div class="demo-block">
  <BtDatePicker v-model:range-start="rangeStart" v-model:range-end="rangeEnd" range placeholder="Wybierz zakres" lang="pl" />
