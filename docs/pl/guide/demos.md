...
<div class="demo-block">
  <button class="lang-btn" @click="toggleTheme" style="margin-bottom: 12px; padding: 8px 16px;">{{ isDark ? 'Jasny motyw' : 'Ciemny motyw' }}</button>
  <StitchDatePicker v-model="singleDate" placeholder="Wybierz date" lang="pl" />
</div>
...
<div class="demo-block">
  <StitchDatePicker v-model:range-start="rangeStart" v-model:range-end="rangeEnd" range placeholder="Wybierz zakres" lang="pl" />
