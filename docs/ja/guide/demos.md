...
<div class="demo-block">
  ...
  <BtDatePicker v-model="singleDate" placeholder="日付を選択" lang="ja" />
</div>
...
<div class="demo-block">
  <BtDatePicker v-model:range-start="rangeStart" v-model:range-end="rangeEnd" range placeholder="範囲を選択" lang="ja" />
