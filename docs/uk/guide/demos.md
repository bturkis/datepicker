...
<div class="demo-block">
  ...
  <BtDatePicker v-model="singleDate" placeholder="Оберіть дату" lang="uk" />
</div>
...
<div class="demo-block">
  <BtDatePicker v-model:range-start="rangeStart" v-model:range-end="rangeEnd" range placeholder="Оберіть діапазон" lang="uk" />
