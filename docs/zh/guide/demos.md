...
<div class="demo-block">
  ...
  <StitchDatePicker v-model="singleDate" placeholder="选择日期" lang="zh" />
</div>
...
<div class="demo-block">
  <StitchDatePicker v-model:range-start="rangeStart" v-model:range-end="rangeEnd" range placeholder="选择范围" lang="zh" />
