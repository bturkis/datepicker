...
<div class="demo-block">
  <button class="lang-btn" @click="toggleTheme" style="margin-bottom: 12px; padding: 8px 16px;">{{ isDark ? 'الوضع الفاتح' : 'الوضع الداكن' }}</button>
  <StitchDatePicker v-model="singleDate" placeholder="اختر التاريخ" lang="ar" />
</div>
...
<div class="demo-block">
  <StitchDatePicker v-model:range-start="rangeStart" v-model:range-end="rangeEnd" range placeholder="اختر النطاق" lang="ar" />
