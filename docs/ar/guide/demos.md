...
<div class="demo-block">
  ...
  <BtDatePicker v-model="singleDate" placeholder="اختر التاريخ" lang="ar" />
</div>
...
<div class="demo-block">
  <BtDatePicker v-model:range-start="rangeStart" v-model:range-end="rangeEnd" range placeholder="اختر النطاق" lang="ar" />
